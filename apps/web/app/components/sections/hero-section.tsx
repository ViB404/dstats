    ...
    >
      <div className="grid w-full items-center gap-16 lg:grid-cols-2">
        <div className="flex flex-col gap-8">
          ...
          <motion.p
            variants={itemVariants}
            className="max-w-lg text-lg text-neutral-400"
          >
            Monitor guild joins, leaves, and bot activity with a single API key.
            Connect your client, and DStats handles the infrastructure
            automatically.
          </motion.p>
