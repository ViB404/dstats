...
export default function HeroSection() {
	...
	return (
		<motion.section
			...
			initial="hidden"
			animate="show"
			className="relative mx-auto flex min-h-[80vh] w-full max-w-7xl overflow-hidden px-4 py-20 md:px-12"
		>
			<div className="grid w-full items-center gap-16 lg:grid-cols-2">
				<div className="flex flex-col gap-8">
					...
					<motion.div variants={itemVariants} className="flex flex-wrap gap-4 mt-4">
						<Button nativeButton={false} className="px-8 py-5" render={<Link href="/dashboard/api-keys" />}>
						...
						>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<h3 className="font-headline font-semibold text-white">MemeOClock</h3>
								</div>
							</div>
