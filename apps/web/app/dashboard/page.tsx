			...
			<main className="grow w-full max-w-7xl mx-auto px-4 md:px-12 pt-32 pb-12">
				{isLoading && page === 1 ? (
					<div className="w-full h-[60vh] flex flex-col items-center justify-center text-neutral-500 gap-4">
						...
						<p className="font-mono text-sm tracking-widest uppercase">Fetching Live Analytics...</p>
					</div>
				) : (
					<motion.div
							...
							{guilds.length === 0 ? (
								<div className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-[#121212]/60 px-8 py-16 text-center">
									...
									<p className="mt-2 max-w-sm text-sm leading-6 text-neutral-400">
										This bot hasn't joined or left any servers yet. Guild activity will appear here
										once events start being tracked.
									</p>
								</div>
							) : (
								<motion.div
								...
								>
									{guilds.map(guild => {
										...
										return (
											<motion.div key={guild.discord_guild_id} variants={itemVariants}>
